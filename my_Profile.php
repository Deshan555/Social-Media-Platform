        ...
        <div class="bg-white shadow rounded overflow-hidden">
            ...
            <div class="px-4 py-3">
                ...
                <div class="p-4 rounded shadow-sm bg-light">
                    ...
                    <p class="mb-1"><i class="bi bi-envelope"></i>Email : <?php echo " ".$_SESSION['email'] ?></p>

                    <p class="mb-1"><i class="bi bi-box-arrow-up-right"></i>FaceBook : <?php echo " ".$_SESSION['facebook'] ?></p>

                    <p class="mb-1"><i class="bi bi-whatsapp"></i>WhatsApp : <?php echo " ".$_SESSION['whatsapp'] ?></p>
